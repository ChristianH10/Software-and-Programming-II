 ...
 * object.)
 *
 * @author CHRISTIAN HILLAH
 */
public class CargoBox {

    /**
     * Internal storage for Items in this CargoBox it stores only non-null Item references.
     * Invariant items is never null because it contains no null elements.
     */
    ...
    public void keepOnlyItemsWith(int maxItemWeightInGrammes) {
        items.removeIf(item -> item.getWeightInGrammes() > maxItemWeightInGrammes);
    }
    ...
    public double averageWeightInGrammes() {
        ...
        return (double) totalWeightInGrammes() / items.size();
    }
